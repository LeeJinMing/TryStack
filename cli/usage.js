...
function usage() {
  console.log(
    [
      ...
      "  verify-policy   Validate recipes against Verified Policy (static)",
      ...
      "  --json          (list/doctor/verify-recipes/verify-policy) output machine-readable JSON",
      "  --recipes-dir <path>  (verify-recipes) override recipes root dir",
      "  --recipes-dir <path>  (verify-policy) override recipes root dir",
      "  --mode <verified|community> (verify-policy) policy mode (default: verified)",
